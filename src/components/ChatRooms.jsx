...
function ChatRooms() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Navbar */}
      <header className="sticky top-0 z-40 w-full backdrop-blur-md bg-gray-900/80 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-r from-gray-800 to-gray-700 text-white p-2.5 rounded-xl shadow-lg shadow-black/20 select-none hover:from-gray-700 hover:to-gray-600 transition-all duration-300">
            ...
            <span className="text-xl font-bold tracking-tight text-white select-none">Open Chat</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white relative border border-gray-800">
          ...
          <div className="relative p-8 flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <p className="mb-5 text-gray-300 leading-relaxed max-w-xl">Explore our most active space and meet people already chatting. Jump in or pick another room below.</p>
              <button
                onClick={() => navigate(`/${rooms[0].id}`)}
                className="inline-flex items-center gap-2 px-6 py-3 bg-gray-800 text-white font-medium rounded-xl shadow-lg hover:bg-gray-700 active:scale-[.98] transition-all border border-gray-700"
              >
                Explore Now
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {rooms.map((room) => (
              <div
                ...
                className="group cursor-pointer bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700 hover:-translate-y-2 flex flex-col h-full"
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto">
                    <button className="w-full bg-gray-800 text-white px-6 py-3 rounded-xl font-medium border border-gray-700 hover:bg-gray-700 transition-all active:scale-95 shadow-xl">
                      Join Room
                    </button>
                  </div>
                </div>              </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center">
          <a href="" target="_blank" className="text-sm text-gray-500 hover:text-gray-400 transition-colors">© 2025 Open Chat. Developed By Rahul</a>
        </div>
      </div>
    </div>
  );
